...
const GeneratedDocument = {
  ...
  async create(docData) {
    ...
    const {
      ...
      docx_base64 = null,
      pdf_base64 = null,
      pages, // Array of { page_number, png_gridfs_id, png_base64 }
      page_count,
      conversion_status = 'unavailable',
      conversion_error = null
    } = docData;

    if (!filing_number || (!docx_gridfs_id && !docx_base64)) {
      throw new Error('Filing number and DOCX content (gridfs_id or base64) are required');
    }
    ...
    const newDoc = {
      filing_number,
      docx_gridfs_id: docx_gridfs_id || null,
      pdf_gridfs_id: pdf_gridfs_id || null,
      docx_base64: docx_base64 || null,
  ...
  async updateDocument(docId, docData) {
    if (!db) throw new Error('Database not connected');
    const { docx_gridfs_id, pdf_gridfs_id, docx_base64, pdf_base64, pages, page_count, conversion_status = 'unavailable', conversion_error = null } = docData;
    const updates = {
      pages: pages || [],
      page_count: page_count || (pages ? pages.length : 0),
      conversion_status,
    ...
    if (docx_gridfs_id !== undefined) updates.docx_gridfs_id = docx_gridfs_id;
    if (pdf_gridfs_id !== undefined) updates.pdf_gridfs_id = pdf_gridfs_id;
    if (docx_base64 !== undefined) updates.docx_base64 = docx_base64;
    if (pdf_base64 !== undefined) updates.pdf_base64 = pdf_base64;
